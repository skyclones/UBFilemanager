package com.unusedbrain.ubfilemanager.activities
...
import kotlinx.android.synthetic.main.activity_about_my.*
import java.util.*

class AboutMyActivity : BaseSimpleActivity() {
    private var appName = ""
    ...
    private fun setupWebsite() {
        val websiteText = String.format(getString(R.string.two_string_placeholder), "Our website", "\nhttp://www.unusedbrain.com/")
        about_website.text = websiteText
    }

    private fun setupEmail() {
        val label = getString(R.string.email_label)
        val email = "studios@unusedbrain.com"
    ...
    private fun setupFAQ() {
        ...
        about_faq_label.visibility = View.INVISIBLE
        about_faq.visibility = View.GONE
    }
    ...
    private fun setupMoreApps() {
        about_more_apps.setOnClickListener {
            launchViewIntent("https://play.google.com/store/apps/dev?id=7871542698343721418")
        }
    ...
    private fun setupLicense() {
        ...
        about_license.visibility = View.GONE
    }
    ...
    private fun setupFacebook() {
        about_facebook.setOnClickListener {
            var link = "https://www.facebook.com/unusedbrainstudios"
            try {
                packageManager.getPackageInfo("com.facebook.katana", 0)
                link = "fb://page/691802367565867"
    ...
    private fun setupGPlus() {
        ...
        about_gplus.visibility = View.GONE
    }

    private fun setupCopyright() {
        val versionName = intent.getStringExtra(APP_VERSION_NAME) ?: ""
        val year = Calendar.getInstance().get(Calendar.YEAR)
        about_copyright.text = String.format("$versionName\nCopyright © Unusedbrain Studios $year")
    }
