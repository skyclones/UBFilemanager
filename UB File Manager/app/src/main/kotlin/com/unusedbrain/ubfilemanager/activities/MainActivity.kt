...
import com.unusedbrain.ubfilemanager.dialogs.ChangeSortingDialog
import com.unusedbrain.ubfilemanager.extensions.config
import com.unusedbrain.ubfilemanager.fragments.ItemsFragment
...
//        startAboutActivity(R.string.app_name, LICENSE_MULTISELECT or LICENSE_GLIDE or LICENSE_PATTERN or LICENSE_REPRINT, BuildConfig.VERSION_NAME, faqItems)
        ...
        Intent(applicationContext, AboutMyActivity::class.java).apply {
            putExtra(APP_ICON_IDS, getAppIconIDs())
            putExtra(APP_LAUNCHER_NAME, getAppLauncherName())
            putExtra(APP_NAME, getString(R.string.app_name))
            putExtra(APP_LICENSES, LICENSE_MULTISELECT or LICENSE_GLIDE or LICENSE_PATTERN or LICENSE_REPRINT)
